...
@Autonomous(name = "TwoStoneAutonomousRedSide", group = "Red")
public class TwoStoneAutonomousRedSide extends LinearOpMode implements AutonomousConstants, TeleOpConstants {
