 ...
 * @deprecated
 */
@Autonomous(name = "ODS Lineup", group = "Test")
// @Disabled
public class ODSLineup extends LinearOpMode implements AutonomousConstants {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            telemetry.addData("isPressed", this.frontODS.isPressed());
            telemetry.addData("ODS Distance", this.frontODS.getSensor().getDistance(DistanceUnit.MM));
            telemetry.update();
            sleep(1);
        }
    }
